          ...
          <div className="flex flex-col items-center text-center mb-16 md:mb-32">
            ...
            <div className="mx-auto max-w-2xl">
              <div className="relative inline-block">
                <span aria-hidden="true" className="absolute left-0 top-1/2 -translate-y-1/2 h-10 w-px bg-border"></span>
                <p className="text-base md:text-lg text-mondro-stone font-light leading-relaxed text-center pl-5 md:pl-6">
